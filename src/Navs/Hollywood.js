...
function Hollywood(){
    return(
        <>
            ...
            <hr className="rule2"/>
                        <Card2 images={h1} heading="The Lord Of The Rings"/>
                        <Card2 images={h2} heading="Tom Cruise Oblivion"/>
                        <Card2 images={h3} heading="London Has Fallen"/>
                        <Card2 images={h4} heading="Harry Potter"/>
                        <Card2 images={h5} heading="The Maze Runner"/>
                        <Card2 images={h6} heading="Gravity"/>
